...
setPaths(modulePath = file.path("C:/Users/Tati/Documents/GitHub/NWT/modules"))
...
If `sourceURL` is specified, `downloadData("birdsNWT", "path/to/modules/dir")` may be sufficient.
