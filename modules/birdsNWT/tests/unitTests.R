...
test_dir("C:/Users/Tati/Documents/GitHub/NWT/modules/birdsNWT/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/Tati/Documents/GitHub/NWT/modules/birdsNWT/tests/testthat/test-template.R")
