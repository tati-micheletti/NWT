...
test_dir("C:/Users/jemar270/Documents/GitHub/fireSense_NWT_DataPrep/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/jemar270/Documents/GitHub/fireSense_NWT_DataPrep/tests/testthat/test-template.R")
