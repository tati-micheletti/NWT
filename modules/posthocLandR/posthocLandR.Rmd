...
objects <- list(
  resultsFolders = list(
    LandR.CS_fS_run1 = file.path(getwd(), "outputs", originalDateAnalysis, "LandR.CS_fS/run1"),
    ...
    # LandR.CS_SCFM_run10 = file.path(getwd(), "outputs", originalDateAnalysis, "LandR.CS_SCFM/run10")
  ),
...
inputs <- list()
outputs <- list()
setPaths(outputPath = '/home/tmichele/projects/NWT/outputs/PLOTS')
