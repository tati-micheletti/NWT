...
```{r}
typeOfSimulation <- "climateStatic" #"vegetationStatic", "dynamic"
modelVersion <- "V6"# "V3" #For birds only
```
...
devtools::load_all("/mnt/data/Micheletti/usefun/")
  ...
  if (doBirds){
      setPaths(modulePath = file.path(getwd(), "modules"),
           ...
           outputPath = checkPath(file.path(getwd(), "outputs/23OCT19/birdResults", typeOfSimulation, Run), create = TRUE)
  )
