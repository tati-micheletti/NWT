...
test_dir("/home/tmichele/Documents/GitHub/NWT/modules/waterlandClassification/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/home/tmichele/Documents/GitHub/NWT/modules/waterlandClassification/tests/testthat/test-template.R")
