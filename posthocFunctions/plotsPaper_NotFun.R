...
vegPlots <- vegetationBiomassPlot(pathData = "~/projects/NWT/outputs/SIMULATIONS",
                                              pathOutputs = reproducible::checkPath(
                                                path = file.path(posthocFolder, "vegetationResults"), 
                                                create = TRUE),
...
totBiom_LandR_fS <- raster::raster(file.path(posthocFolder, "vegetationResults/totalBiomass_LandR_fS_2100.tif"))
totBiom_LandR.CS_fS <- raster::raster(file.path(posthocFolder, "vegetationResults/totalBiomass_LandR.CS_fS_2100.tif"))
totBiom_LandR_SCFM <- raster::raster(file.path(posthocFolder, "vegetationResults/totalBiomass_LandR_SCFM_2100.tif"))
totBiom_LandR.CS_SCFM <- raster::raster(file.path(posthocFolder, "vegetationResults/totalBiomass_LandR.CS_SCFM_2100.tif"))
