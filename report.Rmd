...
:--------------------:|:--------------------:|
LandR                 |  10 hours*           |
LandR.CS (climate)    |  10 hours*           |
scfm-fireSense        |  14 hours            | 
anthropogenic         |  10 minutes          |
birdsNWT (84 sp)      |  48 hours            |
...
The RSF model is applied on a decadal time step. The output is a raster layer of relative resource selection across the study area. A map of model prediction error (standard error) is also produced. This error comes from bootstraping the error in the model covariates.
