...
author: Tati Micheletti\textsuperscript 1, Frances Stewart\textsuperscript 2, Eliot
  ...
  Telgen\textsuperscript 5, Ana Raymundo\textsuperscript 5, Alex M. Chubaty\textsuperscript
...
````{r otherspecies, echo=FALSE}
library(data.table)
othersp <- data.table ("speciesCode" = c ("AMCRO", "AMGO", "AMPI","AMRE","AMRO","ATSP","BAWW","BBWO", "BCCH", "BHCO", "BHVI", "BLBW","BLJA", "BRBL","BRTH", "BTNW", "CEDW", "CHSP", "CMWA", "COGR", "CONW","CORA", "CORE", "COYE", "CSWA", "DEJU", "EAKI", "EAPH", "EVGR", "FOSP", "GCKI", "GCTH", "CAJA", "GRCA", "HAFL","HETH","HOLA", "HOWR", "LCSP", "LEFL", "LISP", "MAWA", "MOWA", "NAWA", "NOWA", "OCWA", "OVEN", "PAWA", "PHVI","PIGR", "PISI", "PIWO", "PUFI", "RBGR", "RBNU", "RCKI", "REVI", "RUGR", "RWBL", "SAVS", "SEWR", "SOSP","SWSP", "SWTH", "TEWA", "TOWA", "TRES", "VATH", "VEER", "VESP", "WAVI", "WBNU", "WCSP", "WETA", "WIWA", "WIWR", "WTSP", "WWCR", "YBSA", "YBFL", "YRWA", "YEWA"),
