...
setPaths(modulePath = file.path(dirname(getwd())), cachePath = "/home/tmichele/Documents/GitHub/NWT/outputs/28MAR19/cache",
         inputPath = "/home/tmichele/Documents/GitHub/NWT/outputs/19MAR19", 
         outputPath = "/home/tmichele/Documents/GitHub/NWT/outputs/28MAR19") # Had to override... don't have time to redo the code up there
...
modules <- list("caribouRSF", "caribouPopGrowthModel")

cloudFolderID <- "https://drive.google.com/open?id=1PoEkOkg_ixnAdDqqTQcun77nUvkEHDc0"

waterRaster <- prepInputs(url = "https://drive.google.com/open?id=1nPd03gaVXkkaHorirR4UhYrDi95ZgyJM",
                          targetFile = "waterRasterNW.tif", studyArea = studyAreaEde, rasterToMatch = rasterToMatch,
...
caribous <- simInitAndSpades(times = times, params = parameters, modules = modules,
                 objects = .objectsCaribou, debug = 2)
```
