...
whichComputer <- if (pemisc::user("emcintir")) "LocalMachine" else "388"
...
opts <- options(
  ...
  "reproducible.useCloud" = if (pemisc::user("emcintir")) FALSE else TRUE,
...
SCFM <- cloudCache(simInitAndSpades, times = list(start = 0, end = parameters$caribouPopGrowthModel$recoveryTime+1),
              ...
              #useCloud = TRUE, 
              cloudFolderID = cloudFolderID,
              omitArgs = c("paths", "cloudFolderID", "useCloud", "debug"))
