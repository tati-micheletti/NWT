...
```{r studyArea}
# options(httr_oob_default = TRUE) # Allows it to work on a Linux server
...
modulesBirds_Fire <- list("scfmLandcoverInit", "scfmRegime", "scfmDriver", "scfmIgnition", "scfmEscape", "scfmSpread", "Boreal_LBMRDataPrep", "LandR_BiomassGMOrig","Biomass_regeneration", "LBMR", "birdsNWT")
...
rasterToMatch <- cloudCache(prepInputs, url = "https://drive.google.com/open?id=1fo08FMACr_aTV03lteQ7KsaoN9xGx1Df",
                            studyArea = studyArea,
                            targetFile = "RTM.tif", destinationPath = paths$inputPath[[1]],
                            useCloud = TRUE,
...
# simSCFM <- simInit(times = times, params = parameters,
#                     modules = modulesSCFM,
#                     objects = .objects, paths = paths,
#                     loadOrder = unlist(modulesSCFM))
# simLandR <- simInit(times = times, params = parameters,
#                     modules = modulesLandR,
#                     objects = .objects, paths = paths,
#                     loadOrder = unlist(modulesLandR),
#                     outputs = outputsLandR)
# simBirds <- simInit(times = times, params = parameters,
#                     modules = modulesBirds,
#                     objects = .objects, paths = paths,
#                     loadOrder = unlist(modulesBirds))
# simWet <- simInit(times = times, params = parameters, 
#                     modules = modulesWetland, 
#                     objects = .objects, paths = paths, 
#                     loadOrder = unlist(modulesWetland))
...
# SCFM <- spades(simSCFM, debug = 2)
# LandR_Biomass <- spades(simLandR, debug = 2)
...
# wetlands <- spades(simWet, debug = 2)
