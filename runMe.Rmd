...
if (length(paths$inputPath) == 1) paths$inputPath <- c(paths$inputPath, file.path(paths$modulePath, "scfm/modules"))
...
.objects <- list(
  ...
  "rasterToMatch" = rasterToMatch, ### For wetland Don't use the rasterToMatch!
  "studyArea" = studyArea,
