...
system(paste0("cd ", getwd(),
              " && git submodule foreach git pull"), wait = TRUE) # Ian, if you have all your upstream set as the orignal repos where you want to pull from, add 'upstream' after pull
system(paste0("cd ", getwd(),
              " && git pull"), wait = TRUE)
