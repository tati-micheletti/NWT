...
# To save a run
# saveRDS(object = birdsFireCaribouV1, file = file.path(getwd(), paste0("outputs/birdsFireCaribouV1_", toupper(format(Sys.time(), "%d%b%y")))))
```
...
df <- comparePredictions(polyList = names(birdsFireCaribouV1$scfmDriverPars), simList = birdsFireCaribouV1) %>%
