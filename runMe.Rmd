...
modules <- list("Boreal_LBMRDataPrep", "LandR_BiomassGMOrig","Biomass_regeneration", "LBMR") #list("waterlandClassification")
...
LandR_BiomassNoFire <- spades(mySim, debug = TRUE)
