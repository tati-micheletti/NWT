...
NWTsp <- c("Abie_Bal", "Acer_Neg", "Betu_Pap", "Lari_Lar", "Pice_Gla",
...
sppEquivalencies_CA[, NWT := c(Abie_Bal = "Abie_Bal", 
                               ...
                               Popu_Tre = "Popu_Tre",
                               Popu_Tri = "Popu_Bal",
                               Quer_Mac = "Quer_Mac")[Boreal]]
sppEquivalencies_CA[LandR == "Quer_mac"]$NWT <- "Quer_Mac"
...
.objects <- list(
  "birdsList" = c("REVI", "HETH"), ### JUST TO TEST. REMOVE ONCE WORKING
...
# LandR_Biomass <- spades(simLandR, debug = TRUE)
# birds <- spades(simBirds, debug = TRUE)
wetlands <- spades(simWet, debug = TRUE)
