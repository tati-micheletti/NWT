...
Future versions of the `caribouPopGrowthModel` module could incorporate;
...
### Running birds using the succession model
```{r birds}
...
#                     outputs = outputsLandR, debug = 2))
```
#### Outputs from the birds module - STILL TO ADD
...
#### Outputs from the anthropogenic module - STILL TO ADD
...
```
```
### Running the caribou RSF model

#### Outputs from the caribou RSF model
...
```
### Running the caribou population growth model
```{r caribou}
...
```
#### Outputs from the caribou population growth model - STILL TO ADD
