...
statistical relationships documented at regional and national scales. These processes may not acurately predict localized processes - this discrepency between scales is well documented in ecology (Wiens 1989; Holling 1992; Levin 1992; Burton et al. in review) with
...
EdehzhieOfficial3.url <- "https://drive.google.com/open?id=1fYvNPwovjNtTABoGcegrvdFGkNfCUsxf"
NWT.url <- "https://drive.google.com/open?id=1LUxoY2-pgkCmmNH5goagBp3IMpj6YrdU"
EdeOficial <- "https://drive.google.com/open?id=15n9BOtswKCJ81-us1u8Dbs0WT9f8bagq"
...
And LandR+SCFM+CaribouGrowth  
```{r LandR_SCFM_Caribou}
  

setPaths(modulePath = c(file.path(getwd(), "modules/"), file.path(getwd(), "modules/scfm/modules/")), cachePath = "cache/",
         inputPath = "inputs/", 
         outputPath = "outputs/29MAR19") # Had to override... don't have time to redo the code up there
getPaths() # shows where the 4 relevant paths are

modulesLandR_SCFM_Caribou <- list("scfmLandcoverInit", "scfmRegime", "scfmDriver", "scfmIgnition", "scfmEscape", "scfmSpread",
"Boreal_LBMRDataPrep", "LandR_BiomassGMOrig","Biomass_regeneration", "LBMR", "caribouPopGrowthModel")
  ...
  runVersion <- "V2"
  assign(paste0("EdeLandRSCFMCaribouPopGrw_", runVersion),
         value = simInitAndSpades(times = times,
                                  params = parameters,
                                  modules = modulesLandR_SCFM_Caribou,
                                  objects = .objects,
                                  loadOrder = unlist(modulesLandR_SCFM_Caribou),
                                  outputs = outputsLandR, debug = 2))
...
```{r caribPop_Landr_fS_Edehzhie}
  ...
  runVersion <- "V1"
  assign(paste0("EdeLandRFireSenseCaribouPopGrw_", runVersion),
         value = simInitAndSpades(inputs = inputs, times = times,
                                  params = parameters,
...
>>>>>>> 962167b78141d9509e5036ae6f2cb8c8d60b3805
