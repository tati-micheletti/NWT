...
before introducing the subsequent modules within this project that rely on results from `LandR` (*i.e.* `birdsNWT`, `caribouRSFModel`, and `caribouPopGrowthModel`). This change would address current `LandR` limitation #1.
