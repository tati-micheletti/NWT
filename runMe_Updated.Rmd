...
"Ian Eddy^3^", "Mario van Telgen^2^", "Ceres Barros^1^", "Ana Raymundo^2^", "Alex Chubaty^5^"
...
that are not forested from their analyses; their outputs are based on forested landclasses.
