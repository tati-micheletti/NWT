...
\textcolor{blue}{fireSense}: `fireSense` is a landscape fire simulation module that is sensitive to both climate and vegetation change; it
...
`fireSense` then passes the information on pixels that are burning to `scfmSpread`, which spreads the fires.
