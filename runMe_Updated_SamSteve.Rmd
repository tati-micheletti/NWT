...
<!-- needs to be toned down. Steve will do later Saturday night --!>

This project represents a first comprehensive effort in data integration and ecological modelling to
support decision making forof natural resources; it combines state of the art models from
multiple ecological fields over an extensive spatial area to forecast vertebrate ecology. 
As such, the project's outputs represent a powerful
...
upon in an open and repeatable way that enhances projections through time as well as transparency. 
