...
$$selection probability  ~ Elevation + Elevation^2 + Vrug + Vrug^2 + RoadDensity + Deciduous + Shrub +            
                                                   Herb + Water + RecentBurn + OldBurn$$ [Eqn. 1]
...
#### Figure 6: Caribou population growth rates.
These figures show forecast demographic paramaters with standard errors for the two sets of reporting regions provided `Boreal caribou NT1 range planning regions 2018` and the `Units for ECCC modeling project 2019`. Results are shown for the first four years of the simulation period only, as a sample of the preliminary results.
