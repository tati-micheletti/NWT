...
** Current state: ** Both these modules are completely functional, and currently depend only on having outputs from LandR and a fire model.
...
#### Figure 5: Ovenbird (OVEN) and American Redstart (AMRE) abundance prediction without climate sensitive vegetation (`LandR`) or fire (`scfm`).
<!-- [Figure 5]() TO ADD WHEN IN BC! -->

#### Figure 6: Caribou population growth on the three areas.
<!-- [Figure 6]()TO ADD WHEN I FINISH RUNNING LANDR + SCFM + CARIBOU -->
