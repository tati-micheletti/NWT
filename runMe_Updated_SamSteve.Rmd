...
authors: Tati Micheletti^1, Frances Stewart^2, Eliot McIntire^1,2, Ian Eddy^2,  Ceres
  Barros^1, Jean Marchal^3, Diana Stralberg^4, Mario van Telgen^5, Ana Raymundo^5,
  Alex Chubaty^6, Steve Cumming^5
...
output:
  pdf_document:
          df_print: paged
affiliations: ^1University of British Columbia, ^2 Natural Resources Canada, Canadian
  Forest Service, ^3WavX Inc , ^4 University of Alberta, ^5Universite Laval, ^6fRI
toc: yes
---
...
**LandR**: `LandR` is a spatially explicit model of vegetation dynamics. It models the biomass of cohorts of tree species
...
is done “automatically” should the data or study area change. At the moment, none of the modules within the `LandR` group
...
**scfm-fireSense**: `scfm-fireSense` is a hybrid of two structurally similar landscape fire models, `scfm` and
...
Therefore, `scfm-fireSense` is less sensitive to variation in vegetation and to changes in fire weather than the completet fireSense
...
**anthropogenic**: The `anthropogenic` parent module aims to represent current and project future anthropogenic
...
**birdsNWT**: This module projects species abundance of bird species under forecasted landscape and climate
...
**caribou**: The `caribou` module is composed of two main modules:  `caribouRSFModel` and `caribouPopGrowthModel`. Each
...
**comm_metricsNWT**: This module computes a series of avian community metrics based on the suite of species-level
...
**Edehzhie**: For the third deliverable, we have repeated the analysis developed for the whole BCR6 within NWT territory
